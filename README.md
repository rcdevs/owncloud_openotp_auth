...
RCDevs OpenOTP Plugin for Owncloud version 1.2.0
...
- Owncloud Password (NCP) + OTP (either fill in the input text, or easier by Pressing OK when receiving the Push Notification on mobile).
...
### **********   CHANGELOG  **********
1.0.2
	Add compatibility to Owncloud v13 
...
1.0.1
	Add compatibility to Owncloud v12 
